...
{   
    ...
    void Start()
    {
        DebugUIBuilder.instance.AddLabel("LEADERBOARD");
        DebugUIBuilder.instance.AddLabel("1. DDDD               300");
        DebugUIBuilder.instance.AddLabel("");
        DebugUIBuilder.instance.AddLabel("");
        DebugUIBuilder.instance.AddLabel("");
        DebugUIBuilder.instance.AddLabel("");
        DebugUIBuilder.instance.AddDivider();
        DebugUIBuilder.instance.AddButton("Back", LoadGame);
